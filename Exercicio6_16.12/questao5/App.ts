...
import {Banco} from "../questao4/Banco"
...
class App {
  ...
  exibirExtrato(numero: string): void {
    ...
    if (conta) {
      ...
      console.log("\n=== Extrato da Conta ===");
      console.log(`ID: ${conta.getId}`);
      console.log(`Número da conta: ${conta.getSaldo}`);
  ...
  consultarCliente(): void {
    ...
    if (cliente) {
      console.log(
        `Cliente encontrado: ID ${cliente.getId}, Nome: ${cliente.getNome}, CPF: ${cliente.getCpf}`
      );
    } else {

...
var Banco_1 = require("../questao4/Banco");
...
var App = /** @class */ (function () {
    ...
    App.prototype.inserirConta = function () {
        ...
        var conta = new Conta_1.Conta(numero, saldo); // Cliente será associado posteriormente
    ...
    App.prototype.exibirExtrato = function (numero) {
        ...
        if (conta) {
            ...
            console.log("\n=== Extrato da Conta ===");
            console.log("ID: ".concat(conta.getId));
            console.log("N\u00FAmero da conta: ".concat(conta.getSaldo));
            console.log("Saldo: ".concat(conta.getSaldo));
            if (cliente) {
                console.log("\n=== Dados do Cliente ===");
                console.log("ID: ".concat(cliente.getId));
                console.log("Nome: ".concat(cliente.getNome));
    ...
    App.prototype.consultarCliente = function () {
        ...
        if (cliente) {
            console.log("Cliente encontrado: ID ".concat(cliente.getId, ", Nome: ").concat(cliente.getNome, ", CPF: ").concat(cliente.getCpf));
        }
        else {
    ...
    App.prototype.listarContasSemCliente = function () {
        ...
        for (var i = 0; i < contasSemCliente.length; i++) {
            this.banco.consultarConta(contasSemCliente[i].getNumero);
        }
        this.associarContaCliente();
    };
